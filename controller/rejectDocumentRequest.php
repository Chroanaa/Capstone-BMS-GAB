...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $id = $_POST['id'];
    try {
        recordTechnicalPerformance('reject_document_request_start', 'reject_document_request');
        ...
        $stmt->execute();
        recordTechnicalPerformance('reject_document_request_end', 'reject_document_request');
