                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4 form-floating">
                              <input
                                  ...
                                  required
                                  value="<?= htmlspecialchars($userInfo['first_name'] ?? '') ?>"
                              />
                          ...
                          <div class="col-md-4 form-floating">
                              <input
                                  ...
                                  value="<?= htmlspecialchars($userInfo['middle_name'] ?? '') ?>"
                              />
                          ...
                          <div class="col-md-4 form-floating">
                              <input
                                  ...
                                  required
                                  value="<?= htmlspecialchars($userInfo['last_name'] ?? '') ?>"
                              />
                          ...
                          <div class="col">
                            <div class="form-floating mb-3">
                              <input
                                ...
                                required
                                value="<?= htmlspecialchars($userInfo['House/floor/bldgno.	'] ?? '') ?>"
                              />
                          ...
                          <div class="col">
                            <div class="form-floating mb-3">
                              <input
                                ...
                                placeholder="Street"
                                required
                                value="<?= htmlspecialchars($userInfo['Street'] ?? '') ?>"
                              />
                          ...
                          <div class="col">
                            <div class="form-floating mb-3">
                              <input
                                ...
                                placeholder="From"
                                required
                                value="<?= htmlspecialchars($userInfo['from'] ?? '') ?>"
                              />
                          ...
                          <div class="col">
                            <div class="form-floating mb-3">
                              <input
                                ...
                                placeholder="To"
                                required
                                value="<?= htmlspecialchars($userInfo['to'] ?? '') ?>"
                              />
                          ...
                          <div class="col">
                            <div class="form-floating mb-3">
                              <input
                                ...
                                required
                                value="<?= htmlspecialchars($userInfo['date_of_birth'] ?? '') ?>"
                              />
                          ...
                          <div class="col">
                            <div class="form-floating mb-3">
                              <input
                                ...
                                placeholder="Age"
                                required
                                value="<?= htmlspecialchars($userInfo['Age'] ?? '') ?>"
                              />
                        ...
                        <div class="form-floating mb-3">
                          <input
                            ...
                            required
                            value="<?= htmlspecialchars($userInfo['place_of_birth'] ?? '') ?>"
                          />
                        ...
                        <div class="form-floating mb-3">
                          <input
                            ...
                            required
                            value="<?= htmlspecialchars($userInfo['contact_number'] ?? '') ?>"
                          />
