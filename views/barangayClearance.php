...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5 barangay-clearance-form">
        <h2 class="text-center h2-brgy-clearance">Barangay Clearance</h2>
        <form action="generate_clearance.php" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-12 form-floating">
                <textarea class="form-control" id="purpose" name="purpose" placeholder="Purpose of Clearance" rows="4" required></textarea>
        ...
        <div class="d-grid gap-2">
            <button type="submit" class="btn brgy-clearance-btn btn-primary">Submit</button>
        </div>
