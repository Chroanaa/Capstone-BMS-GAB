...
<body>
        ...
        <div class="row">
          <div class="col-sm-7 col-md-7 col-lg-5 mx-auto mt-5">
            <div class="card card-signin my-5">
              <div class="card-body">
                <h1 class="card-title text-center h5">Provide Id</h1>
                <form action="../controller/checkIfIdExistController.php" method="post">
  ...
  <script type="module">
    ...
    const error = params.get('creds');
    if(error === "alreadyexists"){
      document.querySelector('.card-error').innerHTML += `<div class="alert alert-danger mt-5" role="alert">
       <h4 class = "text-center"> Credentials already exist</h4>
    </div>`
    setTimeout(() => {
      document.querySelector('.card-error').innerHTML = ""
    }, 3000);
